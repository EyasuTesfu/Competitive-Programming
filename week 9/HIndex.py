...
Use binary search to look for the right value in a sorted array and return the 
difference b/n the length of the array and the left most index or the right plus one
The tricky point here is if the value is h index is not in the array and there must be a greater value when finding the difference between length and the part
